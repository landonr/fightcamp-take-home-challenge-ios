...
extension Color {
    ...
    /// Label color
    public static var label: Color = .dynamic(
        light: .black,
        dark: .white)

    /// Disabled label color (excluded acessories)
    public static var disabledLabel: Color = .dynamic(
        light: .gray(level: 2),
        dark: .gray(level: 5))

    /// CTA button title color
    public static var buttonTitle: Color = .white

    /// CTA button background color
    public static var buttonBackground: Color = .brandRed

    /// Primary background color (package view)
    public static var primaryBackground: Color = .dynamic(
        light: .white,
        dark: .black)

    /// Secondary background color (view controller)
    public static var secondaryBackground: Color = .dynamic(
        light: .gray(level: 1),
        dark: .gray(level: 6))
    ...
    /// - Parameter selected: `true` if the thumbnail is selected
    /// - Returns: border color
    public static func thumbnailBorder(selected: Bool) -> Color {
    ...
    /// - Parameter level: 1 to 6, light to dark scale
    /// - Returns: gray color
    private static func gray(level: Int) -> Color {
